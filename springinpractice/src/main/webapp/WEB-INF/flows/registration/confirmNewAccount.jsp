...
<html xmlns:jsp="http://java.sun.com/JSP/Page">
  ...
  <body>
    ...
    <form>
      <input type="button" value="Back" onClick="window.location.href='${flowExecutionUrl}&_eventId=back';"/>&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" value="Next" onClick="window.location.href='${flowExecutionUrl}&_eventId=next';"/>
    </form>
