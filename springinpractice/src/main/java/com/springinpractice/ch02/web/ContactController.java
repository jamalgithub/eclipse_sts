...
public class ContactController {
	...
	public String createContact(HttpServletRequest req,	HttpServletResponse res, @ModelAttribute @Valid Contact contact,
	...
	public String updateContact(HttpServletRequest req, @PathVariable("id") Long id, @ModelAttribute @Valid Contact contact,
			BindingResult result) {
