...
public class PickListController implements Serializable {
    ...
    public void handleTransfer(TransferEvent event) {
    	...
    	MessageUtil.addInfoMessageWithoutKey("List of items transferred :" + event.getItems()+" Is transfer from source to target :"+event.isAdd()+" Is transfer from target to source :"+event.isRemove(),"");
    }
}