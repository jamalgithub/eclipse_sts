...
public class BookController {
	...
	public String getBook(@PathVariable Long bookId, Map<String, Object> map) {
		...
		map.put("book", book);
		return "/book/bookForm"; // ViewResolver will serve /WEB-INF/views/book/bookForm.jsp
	}
	...
	public void initBinder(WebDataBinder binder) {
	    binder.setAllowedFields(new String[] {"id", "name", "code", "price", "authors", "isbn", "publisher", "publishedOn" });
	}
}
