	...
	public static void main(String[] args) {
		...
		try {
			...
			//Teaching staff entity 
		   	TeachingStaff ts1=new TeachingStaff("Gopal", "MSc MEd", "Maths");ts1.setSid(1);
		   	TeachingStaff ts2=new TeachingStaff("Manisha", "BSc BEd", "English");ts2.setSid(2);
		   	
		    //Non-Teaching Staff entity
		   	NonTeachingStaff nts1=new NonTeachingStaff("Satish", "Accounts");nts1.setSid(3);
		   	NonTeachingStaff nts2=new NonTeachingStaff("Krishna", "Office Admin");nts2.setSid(4);
